...
echo ""
echo "	3) edit Broker IP in /var/lib/tftpboot/ltsp/$dir/lts.conf"
echo 
echo "	4) Configure some thin client in your dhcpd.conf (isc-dhcp-server) by adding those parameters : "
